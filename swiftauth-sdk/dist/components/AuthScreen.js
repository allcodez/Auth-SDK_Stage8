    ...
    return (react_1.default.createElement(react_native_safe_area_context_1.SafeAreaView, { style: [defaultStyles.safeArea, userStyles?.container] },
        react_1.default.createElement(react_native_1.View, { style: defaultStyles.innerContainer },
            react_1.default.createElement(react_native_1.View, { style: [defaultStyles.header, userStyles?.header] },
                react_1.default.createElement(react_native_1.Text, { style: [defaultStyles.title, userStyles?.title] }, view === 'login'
                    ? (titles?.loginTitle || 'Welcome Back')
                    : (titles?.signupTitle || 'Create Account')),
                react_1.default.createElement(react_native_1.Text, { style: [defaultStyles.subtitle, userStyles?.subtitle] }, view === 'login'
            ...
            react_1.default.createElement(react_native_1.View, { style: [defaultStyles.footer, userStyles?.footer] },
                react_1.default.createElement(react_native_1.Text, { style: [defaultStyles.footerText, userStyles?.footerText] }, view === 'login' ? "Don't have an account?" : "Already have an account?"),
                react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: () => setView(view === 'login' ? 'signup' : 'login') },
                    react_1.default.createElement(react_native_1.Text, { style: [defaultStyles.linkText, userStyles?.linkText] }, view === 'login' ? ' Sign Up' : ' Sign In'))))));
};
